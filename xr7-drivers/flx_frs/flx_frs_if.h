...
#define FRS_SMAC_CMD_TRANSFER       (1u << 15)  ///< Initiate read/write access to SMAC table
#define FRS_SMAC_CMD_OPERATION      (1u << 14)  ///< Read/write (0/1) operation selection
#define FRS_SMAC_CMD_COLUMN_MASK    0x3000      ///< Bits for table column
...
#define FRS_REG_SMAC_CONFIG         0x0118          ///< SMAC config register (SMAC_TABLE0)
#define FRS_SMAC_CONFIG_ENABLED     (1u << 15)      ///< Enable/disable SMAC entry
#define FRS_SMAC_CONFIG_PRIO        (1u << 13)      ///< Policer priority
...
#define FRS_SMAC_CONFIG_FRAME_PRIO_MASK 0x0700      ///< Bits for frame priority
...
#define FRS_REG_SMAC_FWDMASK        0x011C          ///< Port forward mask (SMAC_TABLE4)
#define FRS_REG_SMAC_TABLE5         0x011D          ///< Reserved, 0x0000 in reset (SMAC_TABLE5)
#define FRS_REG_SMAC_PORT           0x011E          ///< Policed port (SMAC_TABLE6)
...
#define PORT_REG_MACSEC_KEY0_TX(x) ((PORT_REG_MACSEC_BASE + 0x0100) | (x)) ///< Bits 0-255 of TX key
#define PORT_REG_MACSEC_KEY1_TX(x) ((PORT_REG_MACSEC_BASE + 0x0120) | (x)) ///< Bits 0-255 of TX key
#define PORT_REG_MACSEC_KEY0_RX(x) ((PORT_REG_MACSEC_BASE + 0x0180) | (x)) ///< Bits 0-255 of RX key
#define PORT_REG_MACSEC_KEY1_RX(x) ((PORT_REG_MACSEC_BASE + 0x01A0) | (x)) ///< Bits 0-255 of RX key
...
#define PORT_REG_RX_MACSEC_UNTAGGED_L   (PORT_REG_CNT + 0x0130)  ///< RX policed frames low
#define PORT_REG_RX_MACSEC_UNTAGGED_H   (PORT_REG_CNT + 0x0131)  ///< RX policed frames high
#define PORT_REG_RX_MACSEC_NOTSUPP_L    (PORT_REG_CNT + 0x0132)  ///< RX policed frames low
#define PORT_REG_RX_MACSEC_NOTSUPP_H    (PORT_REG_CNT + 0x0133)  ///< RX policed frames high
#define PORT_REG_RX_MACSEC_UNKNOWNSCI_L (PORT_REG_CNT + 0x0134)  ///< RX policed frames low
#define PORT_REG_RX_MACSEC_UNKNOWNSCI_H (PORT_REG_CNT + 0x0135)  ///< RX policed frames high
#define PORT_REG_RX_MACSEC_NOTVALID_L   (PORT_REG_CNT + 0x0136)  ///< RX policed frames low
#define PORT_REG_RX_MACSEC_NOTVALID_H   (PORT_REG_CNT + 0x0137)  ///< RX policed frames high
#define PORT_REG_RX_MACSEC_LATE_L       (PORT_REG_CNT + 0x0138)  ///< RX policed frames low
#define PORT_REG_RX_MACSEC_LATE_H       (PORT_REG_CNT + 0x0139)  ///< RX policed frames high
...
#define PORT_ETH_ADDR_PRIORITY(p)       (((p)<<12) & 0x7000)    ///< set priority
#define PORT_ETH_ADDR_PRIORITY_GET(p)   (((p)>>12) & 0x7)       ///< get priority
