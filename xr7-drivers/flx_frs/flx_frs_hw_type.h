...
// Size of the Static MAC (SMAC) table
#define FLX_FRS_SMAC_TABLE_COLS 4
#define FLX_FRS_SMAC_TABLE_ROWS 7
...
#define FLX_FRS_MEDIUM_CPU 3    ///< Deprecated medium type value
#define FLX_FRS_MEDIUM_IE 4     ///< Deprecated medium type value
